...
const FundadorRoutes = require('./src/api/fundadores/fundadores.routes')
const RedesocialRoutes = require('./src/api/redesociales/redesociales.routes')
...
app.use('/api/redesociales', RedesocialRoutes)
app.use('/', (req, res, next) => {
